...
import { LessonRate } from '../models/lesson-rate';
...
export class LessonRateService {
  ...
  private rates: LessonRate[] = [
    ...
    { effectiveDate: new Date(0), numberOfStudents: 2, price: 230 },
    { effectiveDate: new Date(0), numberOfStudents: 3, price: 180 },
    { effectiveDate: new Date(0), numberOfStudents: 4, price: 130 },
    { effectiveDate: new Date(0), numberOfStudents: 7, price: 90 },
