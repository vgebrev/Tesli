...
export const lessonRates: LessonRate[] = [
  { effectiveDate: new Date(1970, 0, 1), numberOfStudents: 1, price: 300 },
  { effectiveDate: new Date(1970, 0, 1), numberOfStudents: 2, price: 250 },
  { effectiveDate: new Date(1970, 0, 1), numberOfStudents: 3, price: 200 },
  { effectiveDate: new Date(1970, 0, 1), numberOfStudents: 4, price: 150 },
  { effectiveDate: new Date(1970, 0, 1), numberOfStudents: 7, price: 100 },
